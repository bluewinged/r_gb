...
public class OpenglDisplay implements Disposable {
    ...
    /**
     *
     * @param bwidth width of the buffer (actual screen)
     * @param bheight height of the buffer (actual screen)
     * @param tpowerof2 sizes of the underlying texture (larger or equal to
     * buffer)
     * @param fsize size of the tiles the textures is split up (8 or 16 or 32)
     */
    ...
    /**
     * just updates whole texture, for possible shader usage receives RGBA data
     *
     * @param data
     */
